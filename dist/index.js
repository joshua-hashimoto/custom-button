...
function ir() {
  if (Re)
    return D;
  Re = 1;
  var P = Oe, _ = Symbol.for("react.element"), w = Symbol.for("react.fragment"), R = Object.prototype.hasOwnProperty, A = P.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, I = { key: !0, ref: !0, __self: !0, __source: !0 };
  function x(h, l, T) {
    var d, b = {}, m = null, $ = null;
    T !== void 0 && (m = "" + T), l.key !== void 0 && (m = "" + l.key), l.ref !== void 0 && ($ = l.ref);
    for (d in l)
      R.call(l, d) && !I.hasOwnProperty(d) && (b[d] = l[d]);
    if (h && h.defaultProps)
      for (d in l = h.defaultProps, l)
        b[d] === void 0 && (b[d] = l[d]);
    return { $$typeof: _, type: h, key: m, ref: $, props: b, _owner: A.current };
  }
...
function ur() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    var P = Oe, _ = Symbol.for("react.element"), w = Symbol.for("react.portal"), R = Symbol.for("react.fragment"), A = Symbol.for("react.strict_mode"), I = Symbol.for("react.profiler"), x = Symbol.for("react.provider"), h = Symbol.for("react.context"), l = Symbol.for("react.forward_ref"), T = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), m = Symbol.for("react.lazy"), $ = Symbol.for("react.offscreen"), X = Symbol.iterator, Se = "@@iterator";
    function Ce(e) {
    ...
    function Fe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === R || e === I || De || e === A || e === T || e === d || ke || e === $ || we || xe || je || typeof e == "object" && e !== null && (e.$$typeof === m || e.$$typeof === b || e.$$typeof === x || e.$$typeof === h || e.$$typeof === l || // This needs to include all possible module reference object
...
` + a[s].replace(" at new ", " at ");
      ...
      var C = e ? e.displayName || e.name : "", ye = C ? W(C) : "";
    ...
    function Xe(e, r, t, n, i) {
      {
        ...
        t !== void 0 && (ve(t), a = "" + t), Je(r) && (ve(r.key), a = "" + r.key), Be(r) && (v = r.ref, Ge(r, i));
        for (u in r)
    ...
    function me(e, r, t, n, i, u) {
      {
        ...
        if (!o) {
          ...
          v ? a += v : a += ge();
          var s;
          e === null ? s = "null" : B(e) ? s = "array" : e !== void 0 && e.$$typeof === _ ? (s = "<" + (g(e.type) || "Unknown") + " />", a = " Did you accidentally export a JSX literal instead of a component?") : s = typeof e, c("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, a);
        }
        var f = Xe(e, r, t, i, u);
        if (f == null)
          return f;
...
var sr = H.exports;
const fr = "_btnSquare_14c2a_2", lr = {
  btnSquare: fr
}, vr = ({ title: P, onTap: _, ...w }) => sr.jsx("a", { ...w, className: lr.btnSquare, onClick: _, children: P });
export {
  vr as Button
};
